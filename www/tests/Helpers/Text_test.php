...
{
    private $test="Esse nostrud sunt id tempor amet eiusmod anim. ";
    ...
    public function testExcerptDefaultEndWhiteSpace()
    {
        ...
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim.'.
            ' Esse nostrud sunt id tempor amet eiusmod anim. Essen...',
            Text::excerpt($text, 100)
        );
    }
    public function testExcerpt50()
    {
        $text = $this->$text.$this->$text.$this->$text.$this->$text.$this->$text.$this->$text;
        $this->assertEquals(
    ...
    {
        $text = "Essenostrudsuntidtemporameteiusmod".
        "EssenostrudsuntidtemporameEssenostrudsunt";
        $this->assertEquals(
    ...
    public function testExcerptDefaultWithHTML()
    {
        ...
        "<section>Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt".
        " id tempor amet eiusmod anim.</section>";
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor '.
            'amet eiusmod anim. Esse nostrud...',
            Text::excerpt($text)
        );
    }
}
